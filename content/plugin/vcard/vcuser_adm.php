...
include "../../core/connect/conexao.php";
 $cod = $_GET['cod'];   
	$mostraDados = mysqli_query($conecta,  "SELECT * FROM contato_adm WHERE cod = '$cod' ")or die (mysqli_error());
	...
	$cidade       = $linha["cidade"];
     ...
     header("Content-Disposition: attachment; filename=adm_$arquivo.vcf");
