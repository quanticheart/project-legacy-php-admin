<div id="emailr" class="modal fade" tabindex="-1" data-width="760" style="display: none;">
	...
	<div class="modal-body">
		<form action="content/plugin/btemail/php/envia.php" method="post" name="form1" class="form-validacao">
			<div class="msg_input">
				...
				<input type="text" class="col-xs-6 validacao" id="telefone2" name="telefone" placeholder="Celular" required />
				...
				<input class="col-xs-6 BTApaga btn btn-danger" type="reset" name="BTApaga" value="Apagar"> </div>
		</form>
	</div>
