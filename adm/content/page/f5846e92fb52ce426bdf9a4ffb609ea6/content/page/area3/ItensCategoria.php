...
$id = (int)$_GET["id"];
$nome = $_GET["nome"];
$mostraDados = mysqli_query($conecta,  "SELECT id, id_usuario, id_cat, codigoanuncio, titulo, data, ativo, destaque, destaqueluxo FROM artigo WHERE id_cat = '$id' AND id_usuario = '$idUsuario' ORDER BY id DESC")or die (mysqli_error());
      ...
      <tr>
	    <td class='op' >
		 <div class='box'>
		  ...
		  include ('content/page/area2/menutab/menu_tab_user.php');
