...
$id = (int)$_GET["id"];
$nome = $_GET["nome"];
$mostraDados = mysqli_query($conecta,  "SELECT id, id_cat, codigoanuncio, titulo, data, ativo, destaque, destaqueluxo FROM artigo WHERE id_corre = '$id' ORDER BY id DESC")or die (mysqli_error());
