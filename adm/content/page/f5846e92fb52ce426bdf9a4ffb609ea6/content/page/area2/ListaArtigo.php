...
$mostraDados = mysqli_query($conecta,  "SELECT id, id_usuario, id_cat, codigoanuncio, titulo, data, ativo, destaque, destaqueluxo FROM artigo WHERE id_usuario = '$idUsuario' AND ativo = 's' ORDER BY id DESC")or die (mysqli_error());
